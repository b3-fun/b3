...
<CardGroup cols={2}>
  <Card title="Servicio de Almacenamiento" icon="database" href="/es/createkit/storage">
    Aprende sobre las opciones de almacenamiento para metadatos de NFTs
  </Card>

  <Card title="Solución de Problemas" icon="wrench" href="/es/createkit/error-handling">
