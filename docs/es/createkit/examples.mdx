---
title: Ejemplos
description: Ejemplos de implementación completos para casos de uso comunes de CreateKit
lang: es
...
```typescript title="Colección de Arte Básica"
import { 
  CollectionManager, 
  BaseMintStorage, 
  b3Testnet 
...
<Accordion title="Ejemplo Completo de Colección de Juegos">
```typescript
import { 
  CollectionManager, 
  WhitelistManager,
...
<Accordion title="Ejemplo de Plataforma Multi-Colección">
```typescript
import { 
  CollectionManager, 
  BaseMintStorage,
