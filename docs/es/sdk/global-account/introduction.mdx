...
Las Cuentas Globales B3 son un sistema de autenticación unificado que proporciona a los usuarios una identidad única en todo el ecosistema B3. Los usuarios pueden autenticarse una vez y acceder de manera fluida a todas las aplicaciones, juegos y servicios de B3.
...
<Card title="Gestión de Sesiones" icon="key">
  Autenticación segura con clave de sesión con permisos personalizables.
</Card>
...
- `SignInWithB3`: Flujo completo de autenticación
- `RequestPermissionsButton`: Gestión de permisos
- `AccountAssets`: Muestra los activos del usuario
