...
<Note>
  Esta es una **demostración en vivo e interactiva** utilizando el SDK de B3 real. Cuando no especificas `strategies`, se muestran todas las opciones de autenticación disponibles. Ve la [página completa de demostración](https://global.b3.fun/demos) para más ejemplos.
</Note>
...
Puedes permitir a los usuarios elegir entre múltiples proveedores de autenticación específicos:
