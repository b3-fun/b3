...
<Note>
  Esta es una **demo interactiva en vivo** utilizando el SDK de B3 actual. Cuando no especificas `strategies`, se muestran todas las opciones de autenticación disponibles. Ver la [página completa de la demo](https://global.b3.fun/demos) para más ejemplos.
</Note>
...
<iframe
  ...
  title="Demo de Múltiples Estrategias de Autenticación"
/>
...
<Card title="Manejo de Errores" icon="exclamation-triangle">
  Implementa un manejo de errores exhaustivo para una mejor experiencia de usuario.
</Card>
...
<ParamField path="strategies" type="AllowedStrategy[]">
  Array de estrategias de autenticación para mostrar. Las opciones incluyen: `"google"`, `"discord"`, `"x"`, `"apple"`, `"walletConnect"`, `"io.metamask"`, `"com.coinbase.wallet"`. 
...
<ParamField path="closeAfterLogin" type="boolean" default="false">
  Si cerrar o no el modal después de un inicio de sesión exitoso.
</ParamField>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>`"apple"`</td>
      <td>Social</td>
      <td>Inicio de Sesión con Apple</td>
    </tr>
    <tr>
      <td>`"guest"`</td>
