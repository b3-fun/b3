    ...
    <div className="setup-step">
      ...
      <div className="auth-options">
        ...
        <SignInWithB3
          ...
          partnerId="epic-game-studio"
          onLoginSuccess={(account) => {
            console.log("Jugador de Discord se unió:", account.displayName);
          }}
        />
      </div>
    </div>
...
function PermissionStep() {
  const gamePermissions = {
    ...
    nativeTokenLimitPerTransaction: 0.001, // Límite pequeño de ETH para gas
  };
...
## Ejemplo Avanzado de Hook Personalizado
