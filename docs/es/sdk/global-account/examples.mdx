---
title: Ejemplos
description: Ejemplos completos y patrones de integración para B3 Global Accounts
lang: es
...
function AuthenticationStep() {
  return (
    <div className="setup-step">
      ...
      <p>Conecta tu Cuenta Global B3 para comenzar a jugar</p>
    ...
    <div className="guest-shop">
      <section className="hero">
        ...
        <SignInWithB3
          ...
          partnerId="nft-marketplace"
          onLoginSuccess={() => {
            console.log("¡Usuario se unió al mercado!");
          }}
        />
      </section>
...
function MarketplaceGrid() {
  // Elementos simulados del mercado
  const items = [
...
## Ejemplo de Enrutador de Aplicación Next.js
