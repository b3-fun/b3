...
El B3 SDK (`@b3dotfun/sdk`) es un SDK unificado de TypeScript que proporciona todo lo que necesitas para construir aplicaciones en el ecosistema B3. Combina una poderosa infraestructura de pagos entre cadenas con autenticación sin fisuras, todo envuelto en componentes React amigables para el desarrollador y servicios sin interfaz.
...
<CardGroup cols={2}>
  ...
  <Card title="Identidad Multiplataforma" icon="globe">
    Identidad única que funciona en todas las aplicaciones y juegos de B3.
  </Card>
...
1. [**Instalar el SDK**](#installation) e importar los estilos
2. [**Configurar AnySpend**](/anyspend/introduction) para pagos entre cadenas
3. [**Configurar Cuentas Globales**](/sdk/global-account/authentication) para autenticación de usuarios
4. [**Explorar ejemplos**](/anyspend/examples) y patrones de implementación
5. [**Unirse a la comunidad**](https://discord.gg/b3dotfun) para soporte y actualizaciones
