...
<Card title="Intercambios Entre Cadenas" icon="arrow-right-arrow-left">
  Habilita intercambios de tokens sin fisuras en más de 20 blockchains soportadas con enrutamiento óptimo.
</Card>
...
<Card title="Rampas de Fiat" icon="credit-card">
  Rampas de fiat a cripto integradas para usuarios sin criptomoneda existente.
</Card>
</CardGroup>
...
<Card title="Soporte para Desarrolladores" icon="handshake" href="https://b3builders.typeform.com/bsmntdevelopers">
  Obtén ayuda para integrar el B3 SDK en tu proyecto.
</Card>
