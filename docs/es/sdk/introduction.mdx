...
<CardGroup cols={2}>
  ...
  <Card title="Rampas de Entrada Fiat" icon="credit-card">
    Rampas de entrada de fiat a cripto integradas para usuarios sin criptomoneda existente.
  </Card>
</CardGroup>
...
Para desarrolladores que necesitan el máximo control, toda la funcionalidad está disponible a través de servicios sin interfaz:
