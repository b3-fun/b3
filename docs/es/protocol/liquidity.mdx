...
description: >-
  Cómo AnySpend (desarrollado por B3) abstrae las capas de ejecución para
...
<Card title="Liquidez Fragmentada" icon="puzzle-piece">
  Cada cadena mantiene pozos aislados, limitando la profundidad y aumentando el deslizamiento.
</Card>
...
Impulsado por nuestro producto, AnySpend, opera en la capa de ejecución del cliente, situándose entre la intención del usuario y la ejecución de la blockchain:
...
3. **Descubrimiento de Ruta**: Encuentra caminos óptimos a través de todas las cadenas soportadas
4. **Ejecución Atómica**: Las transacciones se ejecutan de manera atómica o fallan de forma elegante
