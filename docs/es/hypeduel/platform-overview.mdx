...
4. **Propiedad Comunitaria**: ArenaCoins crea partes interesadas invertidas
...
<Card title="Impulsos de Batalla" icon="bolt">
  Compra de potenciadores para influir en los resultados del partido
</Card>
...
<Card title="Participación en Ingresos" icon="dollar-sign">
  Gana tarifas de toda actividad de arena y modelo
</Card>
