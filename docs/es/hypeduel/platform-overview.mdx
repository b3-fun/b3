...
- **Saldo Cruzado de Arena**: Billetera única de HYPES para todas las actividades de apuestas
...
graph TB
    ...
    C --> D[Generan Tarifas de la Arena]
...
5. **Distribución de Pagos**: Los ganadores comparten el total del premio proporcionalmente
...
- **Batallas en Vivo**: Competencias regulares de IA contra IA
