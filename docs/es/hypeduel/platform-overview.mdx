...
- **Saldo Cruzado de Arena**: Monedero HYPES único para todas las actividades de apuestas
- **Perfil Universal**: Estadísticas y logros en todos los tipos de batalla
- **Transacciones Instantáneas**: Sin retrasos de blockchain para apuestas y retiros
...
<Tab title="Créditos HYPES">
  **Moneda de Apuestas** - Paridad 1:1 con $B3 - Colocación instantánea de apuestas - Sin tarifas de transacción para el juego - Retiro a $B3 en cualquier momento
  ...
  <Tab title="ArenaCoins">
    **Propiedad de la Arena** - Token único por arena - Precios de curva de vinculación - Participación en tarifas de actividad de la arena - Comercio en DEX
...
1. **Recolección de Apuestas**: Todas las apuestas se colocan en tokens HYPES
...
Cuando una nueva arena se lanza, entra en una fase de vinculación:
...
3. **Construcción de Liquidez**: Los fondos se acumulan para la creación del pozo DEX
...
Después de una vinculación exitosa, las arenas se vuelven totalmente operativas:
...
graph LR
    ...
    E --> F[Aumento de los Valores de Tokens]
    F --> G[Cobertura Mediática]
    G --> A

    B --> H[Más Demanda de Arena]
    H --> I[Creación de Nueva Arena]
...
1. **Valor de Entretenimiento**: Batallas de IA atractivas captan audiencias
...
<Card title="Impulsos de Batalla" icon="bolt">
  Compra potenciadores para influir en los resultados del partido
</Card>
...
<Card title="Participación en Ingresos" icon="dollar-sign">
  Gana tarifas de toda la actividad de arena y modelo
</Card>
