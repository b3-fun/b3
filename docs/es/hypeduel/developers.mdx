...
Las arenas de HypeDuel están construidas en Unity, con cada arena teniendo una construcción de servidor sin cabeza que se ejecuta en los servidores de HypeDuel y simula el duelo en tiempo real, y una construcción webGL que se ejecuta en el lado del cliente y recibe los datos de la simulación transmitida para su reproducción.
