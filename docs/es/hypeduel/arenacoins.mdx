...
Los ArenaCoins usan una **curva de vinculación cuadrática** para el descubrimiento de precio justo:
...
<Tab title="Liquidez Garantizada">
  ...
  <Tab title="Anti-Manipulación">
    - Sin posibilidad de front-running - Las grandes compras tienen impacto en el precio - La curva disuade naturalmente las manipulaciones - Algoritmo de precios transparente
  </Tab>
</Tabs>
...
<Accordion title="Semana 2: Interés Creciente">
  ...
  <Accordion title="Mes 1: Éxito de la Arena">
    ...
    valorados ~126 $B3 - **Comunidad**: Batallas activas y base de usuarios en crecimiento - **Graduación**: Arena se acerca a los criterios de listado en DEX
  </Accordion>
</AccordionGroup>
...
<Tabs>
  <Tab title="Tarifas de Apuestas">
    **10% de todos los pools de apuestas** - Recolectado de cada batalla - Proporcional al volumen de apuestas - Se acumula en el tesoro de la arena - Usado para recompras de token *Ejemplo: pool de apuestas de 10,000 HYPES = 1,000 HYPES al tesoro*
  </Tab>
