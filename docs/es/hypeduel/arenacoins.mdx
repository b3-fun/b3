...
<Card title="Precios de Curva de Vinculación" icon="trending-up">
  Descubrimiento de precios justo a través de curvas matemáticas, sin posibilidad de adelantarse
</Card>
...
Los ArenaCoins utilizan una **curva de vinculación cuadrática** para un descubrimiento de precios justo:
...
<Tab title="Liquidez Garantizada">
  ...
  <Tab title="Anti-Manipulación">
    - Sin posibilidad de adelantarse - Las compras grandes tienen impacto en el precio - La curva disuade naturalmente las infladas - Algoritmo de precios transparente
  </Tab>
</Tabs>
