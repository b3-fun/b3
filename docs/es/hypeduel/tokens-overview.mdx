...
<Tab title="Créditos HYPES" icon="bolt">
  **Moneda para Juegos** - Paridad 1:1 con $B3 - Colocación instantánea de apuestas - Cero tarifas de gas - Retiros sin interrupciones - Compras de potenciadores
</Tab>

  <Tab title="ArenaCoins" icon="chart-line">
    **Propiedad de Arena** - Único por arena - Precios de curva de vinculación - Derechos de participación en tarifas - Oportunidades de comercio -
