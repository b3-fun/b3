...
<Tabs>
  <Tab title="$B3 Token" icon="coins">
    **Moneda Fundacional** - Token base del ecosistema - Principal reserva de valor - Utilidad cruzada de plataformas - Reservas del tesoro
...
<AccordionGroup>
  <Accordion title="Transacciones Instantáneas">
    **Problema**: Las transacciones en blockchain tienen retrasos y costos de gas que interrumpen el flujo de juego. **Solución**: HYPES
    permiten apuestas y potenciadores instantáneos sin la fricción de blockchain mientras mantienen respaldo completo de $B3.
  </Accordion>
...
<Accordion title="Captura de Valor">
  **Problema**: Los ingresos de la plataforma normalmente solo benefician al propietario de la plataforma. **Solución**: Las recompras del tesoro de tanto $B3
...
<Card title="Impulsores de Valor de $B3" icon="arrow-right">
  ...
  - Utilidad cruzada de plataformas 
...
<Card title="Apreciación de ArenaCoin" icon="rocket">
  - Crecimiento de popularidad de arena 
...
Los tesoros de arena crean presión de compra sostenida:
