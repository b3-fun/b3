...
<Tab title="Créditos HYPES" icon="bolt">
  **Moneda de Juego** - Paridad 1:1 con $B3 - Colocación instantánea de apuestas - Cero comisiones por transacción - Retiros sin demoras - Compras de potenciadores
</Tab>
...
<AccordionGroup>
  <Accordion title="Transacciones Instantáneas">
    **Problema**: Las transacciones en blockchain tienen demoras y costos de gas que interrumpen el flujo del juego. **Solución**: HYPES
