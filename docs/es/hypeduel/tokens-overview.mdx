...
<Tab title="Créditos HYPES" icon="bolt">
  **Moneda para Juegos** - Paridad 1:1 con $B3 - Colocación instantánea de apuestas - Sin comisiones de gas - Retiros sin demoras - Compras de potenciadores
</Tab>

  <Tab title="ArenaCoins" icon="chart-line">
    **Propiedad de la Arena** - Único por arena - Precios con curva de vinculación - Derechos de participación en comisiones - Oportunidades de comercio -
...
<AccordionGroup>
  <Accordion title="Transacciones Instantáneas">
    **Problema**: Las transacciones en blockchain tienen retrasos y costos de gas que interrumpen el flujo de juego. **Solución**: HYPES
    permiten apuestas y potenciadores instantáneos sin la fricción de blockchain mientras mantienen el respaldo completo de $B3.
  </Accordion>

<Accordion title="Inversión en Arenas">
  **Problema**: No hay forma para que los usuarios inviertan o se beneficien del crecimiento exitoso de una arena. **Solución**: ArenaCoins permiten
