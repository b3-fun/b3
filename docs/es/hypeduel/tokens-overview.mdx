---
title: Visión general de los tokens
...
<Tab title="Créditos HYPES" icon="bolt">
  **Moneda de Juego** - Paridad 1:1 con $B3 - Colocación de apuestas instantáneas - Cero comisiones de gas - Retiros sin demoras - Compras de potenciadores
</Tab>

  <Tab title="ArenaCoins" icon="chart-line">
    **Propiedad de la Arena** - Único por arena - Precios de curva de vinculación - Derechos de participación en comisiones - Oportunidades de comercio -
...
graph TB
    ...
    C --> D[Colocar Apuestas & Comprar Potenciadores]
    D --> E[Generar Ingresos de la Arena]
    E --> F[Tesoro de la Arena]
    F --> G[Comprar $B3]
    F --> H[Comprar ArenaCoins]
    G --> I[Soporte del Precio de $B3]
    H --> J[Aumento del Valor de ArenaCoin]
    J --> K[Atraer Inversores de la Arena]
    I --> L[Atraer Más Jugadores]
    K --> A
    L --> A

    M[Creadores de Arenas] --> N[Lanzar Arena]
...
<Accordion title="Captura de Valor">
  **Problema**: Los ingresos de la plataforma generalmente benefician solo al propietario de la plataforma. **Solución**: Las recompras del tesoro de tanto $B3
...
<Card title="Apreciación de ArenaCoin" icon="rocket">
  ...
  - Aumento de la generación de comisiones 
