...
<Tab title="Créditos HYPES" icon="bolt">
  **Moneda de Juego** - Paridad 1:1 con $B3 - Colocación instantánea de apuestas - Cero comisiones de gas - Retiros sin demoras - Compras de potenciadores
</Tab>

  <Tab title="ArenaCoins" icon="chart-line">
    **Propiedad de Arena** - Único por arena - Precios de curva de vinculación - Derechos de participación en comisiones - Oportunidades de comercio -
...
2. **Asignación de Activos**: 50% para recompras de $B3, 50% para recompras de ArenaCoins
