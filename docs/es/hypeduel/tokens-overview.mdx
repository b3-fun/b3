...
<Tab title="Créditos HYPES" icon="bolt">
  **Moneda de Juego** - Paridad 1:1 con $B3 - Colocación de apuestas instantáneas - Cero comisiones por transacción - Retiros sin demoras - Compras de potenciadores
</Tab>
