...
<Tab title="Créditos HYPES" icon="bolt">
  **Moneda para Juegos** - Paridad 1:1 con $B3 - Colocación instantánea de apuestas - Cero comisiones por transacción - Retiros sin demoras - Compras de potenciadores
</Tab>

  <Tab title="ArenaCoins" icon="chart-line">
    **Propiedad de Arena** - Único por arena - Precios con curva de vinculación - Derechos de compartir comisiones - Oportunidades de comercio -
