...
El Facilitador AnySpend x402 maneja pagos multi-token y transfronterizos para el protocolo x402. Se encarga de los intercambios de tokens, el puenteo entre cadenas y la liquidación para que los desarrolladores puedan aceptar pagos en cualquier token mientras reciben su moneda preferida.
...
- **Stablecoins**: USDC, USDT (en cadenas compatibles)
...
### Enrutamiento transfronterizo

Maneja automáticamente pagos a través de diferentes redes de blockchain:

- **Pagos en la misma cadena**: Transferencias directas de tokens con mínima sobrecarga
- **Pagos transfronterizos**: Puenteo automático entre redes (por ejemplo, ETH → Base)
...
Convierte entre cualquier token compatible:
...
- **Compatibilidad con servidores**: Se puede usar con cualquier middleware x402
- **Sin bloqueo de proveedor**: APIs HTTP estándar, cambie de facilitadores en cualquier momento
...
- Protección contra deslizamiento y resistencia MEV
- Integración de puenteo transfronterizo
...
Lista los esquemas de pago y redes compatibles.
...
- **Liquidación transfronteriza**: 2-5 minutos (depende del puenteo)
...
<Card title="Soporte de Red" icon="network-wired" href="/anyspend/x402-network-support">
  Ver todas las redes y tokens compatibles
</Card>
...
- **Documentos**: [docs.b3.fun](https://docs.b3.fun)
