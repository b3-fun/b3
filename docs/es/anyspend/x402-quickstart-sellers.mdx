...
- No se requiere infraestructura de blockchain ni gestión de wallets
...
El facilitador de AnySpend está alojado en:
...
#### Método 1: Cantidades en dólares simples (Recomendado)
...
Ruta pagos a diferentes wallets basado en el endpoint:
...
Obtén USDC de testnet del [Faucet de Coinbase](https://portal
