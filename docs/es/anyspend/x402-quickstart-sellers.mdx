...
- No se requiere infraestructura de blockchain ni gestión de carteras
...
- **Una dirección de cartera** para recibir pagos en USDC
...
4. El facilitador de AnySpend convierte a USDC y liquida a tu cartera
...
- Recibes exactamente **100 tokens B3** en tu cartera
...
const endpointConfig = {
  '/api/data': {
    price: {
      amount: '1000000000000000000', // 1 token (ajusta decimales)
      asset: {
...
**Método 1: revisar contrato del token**
...
Dirige pagos a diferentes carteras basadas en el endpoint:
