...
Las exportaciones CSV incluyen una fila de encabezado seguida de una fila por transacción:
...
Las exportaciones JSON devuelven un arreglo de objetos de transacción:
...
<CardGroup cols={2}>
  ...
  <Card title="JSON para uso programático" icon="code">
    Las exportaciones JSON son ideales para alimentar datos en tuberías de análisis, bases de datos o paneles personalizados.
  </Card>
</CardGroup>
