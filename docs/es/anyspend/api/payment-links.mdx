...
---
Los enlaces de pago son URLs compartibles que permiten a tus clientes pagar con cualquier token en cualquier cadena soportada. Cada enlace puede ser personalizado con marca, formularios, opciones de envío y más.
...
<ResponseField name="url" type="string">
  La URL de pago compartible (por ejemplo, `https://anyspend.com/pay/pl_abc123`).
</ResponseField>
...
<ResponseField name="expires_at" type="string | null">
  Sello de tiempo de expiración ISO 8601. Nulo para sin expiración.
</ResponseField>
  ...
  <Expandable title="propiedades de form_schema">
    <ResponseField name="fields" type="array">
      ...
      <Expandable title="propiedades de campo">
        <ResponseField name="id" type="string">Identificador único del campo.</ResponseField>
...
<ResponseField name="shipping_options" type="array | null">
  ...
  <Expandable title="propiedades de opción de envío">
    ...
    <ResponseField name="name" type="string">Nombre de visualización (por ejemplo, `"Envío Estándar"`).</ResponseField>
    <ResponseField name="amount" type="string">Costo de envío en la unidad más pequeña del token.</ResponseField>
    <ResponseField name="estimated_days" type="string">Tiempo estimado de entrega (por ejemplo, `"5-7 días hábiles"`).</ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="return_label" type="string | null">
  Etiqueta para el botón de retorno (por ejemplo, `"Volver a la Tienda"`).
</ResponseField>
...
<ResponseField name="branding" type="object | null">
  ...
  <Expandable title="propiedades de branding">
    ...
    <ResponseField name="business_name" type="string">Nombre del negocio mostrado en el pago.</ResponseField>
  </Expandable>
</ResponseField>

<ResponseField name="fee_on_top" type="boolean">
  Si la tarifa de la plataforma se agrega encima del monto del pago (true) o es absorbida por el comerciante (false).
</ResponseField>
...
<ResponseField name="created_at" type="string">
  Sello de tiempo de creación ISO 8601.
</ResponseField>

<ResponseField name="updated_at" type="string">
  Sello de tiempo de la última actualización ISO 8601.
</ResponseField>
...
Todos los parámetros se pasan a los webhooks, así que puedes conciliar pagos en tu backend.
...
<ParamField body="product_id" type="string">
  Enlace a un producto existente.
</ParamField>
...
<ParamField body="theme_color" type="string">
  Código de color hexadecimal para la marca del pago (por ejemplo, `"#6366f1"`).
</ParamField>
...
<ParamField body="expires_at" type="string">
  Sello de tiempo de expiración ISO 8601.
</ParamField>
...
<ParamField body="fee_on_top" type="boolean" default={false}>
  Agregar la tarifa de la plataforma encima del monto del pago.
</ParamField>
