...
<ResponseField name="payment_link_id" type="string | null">
  ID del enlace de pago asociado, si la sesión se creó a partir de un enlace de pago.
</ResponseField>
...
<ResponseField name="form_data" type="object | null">
  Datos de formulario personalizados enviados por el cliente.
</ResponseField>
...
<ResponseField name="completed_at" type="string | null">
  Marca de tiempo de finalización ISO 8601.
</ResponseField>
...
<Tabs>
  <Tab title="Response">
    Devuelve el objeto completo de [Sesión de Pago](#el-objeto-de-sesión-de-pago).
  </Tab>
</Tabs>
...
<Warning>
  Solo las sesiones con `status: "open"` pueden expirar. Intentar expirar una sesión en cualquier otro estado devolverá un error `400 Bad Request`.
