---
title: Clientes
description: Gestiona los registros de clientes y el historial de pagos
lang: es
...
<ResponseField name="first_seen_at" type="string">
  Sello de tiempo ISO 8601 de la primera transacción del cliente.
</ResponseField>

<ResponseField name="last_seen_at" type="string">
  Sello de tiempo ISO 8601 de la transacción más reciente del cliente.
</ResponseField>

<ResponseField name="created_at" type="string">
  Sello de tiempo ISO 8601 de creación.
</ResponseField>

<ResponseField name="updated_at" type="string">
  Sello de tiempo ISO 8601 de la última actualización.
</ResponseField>
...
Actualizar un cliente existente. Solo los campos que incluyas en el cuerpo de la solicitud serán actualizados.
...
Eliminar permanentemente un registro de cliente. El historial de transacciones asociado con este cliente se conserva, pero la referencia al cliente aparecerá como eliminada.
...
<Warning>
  Esta acción es irreversible. Toda la información personal identificable (nombre, email) será eliminada permanentemente.
</Warning>
...
Recuperar el historial de transacciones para un cliente específico.
