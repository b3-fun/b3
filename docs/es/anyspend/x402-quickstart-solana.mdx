...
<Card title="Demostración en Vivo" icon="rocket" href="https://github.com/b3-fun/anyspend-x402-demo">
  Aplicación demo completa en Solana
</Card>
</CardGroup>

## Visión General

Esta guía te muestra cómo usar **AnySpend X402** en **Solana** tanto para aplicaciones de servidor (aceptando pagos) como de cliente (realizando pagos). AnySpend X402 en Solana permite pagos de tokens SPL sin gas usando firmas de transacciones, haciéndolo perfecto para APIs con muro de pago, agentes de IA y servicios premium.
...
- **Amigable con agentes de IA** - Envoltura simple fetch para pagos autónomos
...
- La extensión de billetera está instalada (Phantom, Solflare, etc.)
...
- Consulta los registros del servidor para detectar errores
</Accordion>
</AccordionGroup>
...
- **Código Fuente de la Demostración**: [github.com/b3-fun/anyspend-x402-demo](https://github.com/b3-fun/anyspend-x402-demo)
