...
AnySpend x402 utiliza firmas criptográficas en lugar de aprobaciones de tokens tradicionales, lo que permite **pagos sin gas** para los usuarios. El facilitador paga todas las tarifas de gas mientras que los usuarios simplemente firman mensajes de autorización.

Hay dos estándares de firma principales soportados, cada uno optimizado para diferentes tipos de tokens:
...
transferWithAuthorization(
    ...
    uint256 validBefore,   // Marca de tiempo de la fecha límite
...
El facilitador llama a `permit()` para establecer el límite de gasto en la cadena
</Step>
...
- Estado de nonce almacenado en cadena en mapeo
...
// Verificar que el firmante coincida con la dirección esperada
...
// 2. Obtiene nonce actual (para permit) o genera nonce aleatorio
