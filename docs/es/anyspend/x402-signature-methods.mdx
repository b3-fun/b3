...
AnySpend x402 utiliza firmas criptográficas en lugar de aprobaciones de tokens tradicionales, permitiendo **pagos sin gas** para los usuarios. El facilitador paga todas las tarifas de gas mientras que los usuarios simplemente firman mensajes de autorización.
...
<Note>
El cliente de AnySpend x402 detecta automáticamente qué método de firma usar basado en el contrato del token. No necesitas especificar esto manualmente.
</Note>
...
**Ventajas:**
- Simple y predecible
- Eficiente en gas (único slot de almacenamiento)
...
El cliente de AnySpend x402 maneja toda la complejidad de la firma automáticamente:
...
// 3. Construye los datos tipificados correctos de EIP-712
