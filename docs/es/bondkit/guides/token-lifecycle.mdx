...
description: >-
  ...
  comercio completo en DEX y la descentralización.
lang: es
originalPath: bondkit/guides/token-lifecycle.mdx
---
## Visión General

Esta guía te lleva a través del ciclo de vida completo de un token de Bondkit, desde su creación inicial hasta su total descentralización. Entender este flujo es esencial para lanzamientos y gestiones exitosas de tokens.
...
<AccordionGroup>
  <Accordion title="Elige Tus Parámetros">
    **Decisiones Críticas:**
    ...
    | **tradingToken** | Con qué pagan los usuarios | Usar B3 para la mainnet de Base |
  ...
  <Accordion title="Establecer Estructura de Tarifas">
    ...
    **Flujo de Tarifas:**
    - **Fase de Bonding**: 5% de todas las operaciones → `feeRecipient`
    - **Post-Migración**: 0.3% de tarifas de trading → proveedores de LP
  </Accordion>
</AccordionGroup>
...
**Señales de Alerta:**
- Sin actividad de trading por más de 24 horas
    ...
    **El Proceso de Migración:**
    ...
    if (receipt.status === 'success') {
      ...
      const announcement = `
        ...
        💫 El token ahora está totalmente descentralizado!
      `;
    ...
    **Contenido Educativo:**
    ...
    const migrationGuideForUsers = {
      ...
      risks: {
        ...
        liquidityRisk: "Grandes operaciones pueden impactar el precio",
