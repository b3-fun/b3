...
Empieza aquí para la identificación rápida de problemas:
...
<AccordionGroup>
    ...
    **Soluciones:**
    ...
    async function diagnoseBuyError(token, amount, minTokensOut) {
      ...
      if (progress.progress >= 1.0) {
        return "Objetivo alcanzado - migración disponible, no se pueden comprar más";
      }
  ...
  <Accordion title="Error: 'Fase de Bonding Terminada' o problemas de trading en DEX">
