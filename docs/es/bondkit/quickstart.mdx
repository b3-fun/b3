...
Los tokens BondKit utilizan un sistema de **token de comercio configurable**. Verifica qué token se utiliza para el comercio:
...
```typescript
// Obtener una cotización de precio primero
