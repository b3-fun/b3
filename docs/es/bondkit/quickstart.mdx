...
Esta guía rápida te guiará a través del ciclo de vida completo de un token de BondKit en menos de 5 minutos. Aprenderás cómo:
...
Los tokens de BondKit utilizan un sistema de **token de comercio configurable**. Verifica qué token se utiliza para comerciar:
...
<Warning>
  **Importante**: Después de la migración:
  ...
  - El comercio de la curva de vinculación se desactiva permanentemente
