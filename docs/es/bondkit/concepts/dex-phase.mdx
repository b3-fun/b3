...
**Trading DEX Estándar:**
Los tokens de Bondkit en la fase DEX pueden ser negociados usando cualquier interfaz compatible con Uniswap v4, agregador de DEX o plataforma de trading.
...
- **Pérdida Impermanente**: Riesgos estándar de AMM aplican
...
<CardGroup cols={2}>
  <Card title="Comenzar Trading DEX" icon="arrow-right" href="/bondkit/sdk/reference#bondkitswapservice">
    Aprende a usar BondkitSwapService para trading DEX
  </Card>
  <Card title="Añadir Gráficos de Trading" icon="chart-line" href="/bondkit/sdk/reference#tradingview-component">  
