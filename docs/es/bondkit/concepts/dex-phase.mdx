...
stateDiagram-v2
    ...
    note right of DEXPhase
        ...
        Características completas de trading
...
const poolConfig = {
  ...
  fee: 3000,        // Comisión estándar del 0.3%
...
**Trading Estándar de DEX:**
Los tokens de Bondkit en la fase DEX se pueden negociar utilizando cualquier interfaz compatible con Uniswap v4, agregador de DEX o plataforma de trading.
...
- El precio determinado por la oferta/demanda
...
| **Tipos de Órdenes** | Solo compra/venta | Características completas de DEX |
...
if (status === TokenStatus.Dex) {
  ...
  // Usar métodos de la curva de emisión
...
```typescript
// Características de hooks (aplicadas automáticamente)
const hookFeatures = {
...
**Beneficios LP:**
- **Comisiones de Trading**: Ganar el 0.3% de todo el volumen de intercambio
- **Programas de Incentivos**: Recompensas adicionales potenciales
- **Apreciación de Precio**: Beneficiarse del crecimiento del token
...
**Efectos Inmediatos:**
- ✅ Los tokens permanecen completamente transferibles
- ✅ Pueden comerciar en el mercado abierto
- ✅ Sin períodos de bloqueo
- ⚠️ El precio ahora sujeto a la volatilidad del mercado
...
- **Integración**: Listar en agregadores y plataformas de DEX
...
<AccordionGroup>
  <Accordion title="Estrategias de Trading Óptimas">
    **Gestión del Deslizamiento:**
    ...
    - Verificar el impacto del precio antes de ejecutar
...
<CardGroup cols={2}>
  <Card title="Comenzar Trading DEX" icon="arrow-right" href="/bondkit/sdk/reference#bondkitswapservice">
    Aprende a usar BondkitSwapService para trading de DEX
  </Card>
  <Card title="Agregar Gráficos de Trading" icon="chart-line" href="/bondkit/sdk/reference#tradingview-component">  
    Integra gráficos de TradingView para tus tokens de DEX
  </Card>
  ...
  <Card title="Monitorear Análisis" icon="analytics" href="https://info.uniswap.org">
    Rastrea el rendimiento de DEX de tu token  
  </Card>
</CardGroup>
