...
4. **Precios Automáticos**: No se necesita establecer precios manualmente
...
<Tabs>
  ...
  <Tab title="Casos Límite">
    **Desbordamiento del Objetivo:**
    - Si la compra excede el objetivo, el exceso se reembolsa
...
<Warning>
  **Crítico: Después de la Migración**
  ...
  - ❌ La negociación de la curva de vinculación se deshabilita permanentemente
