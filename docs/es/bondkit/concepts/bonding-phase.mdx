...
<Tabs>
  <Tab title="Cómo Funciona">
    **Flujo de Proceso:**
    ...
    2. El contrato calcula tokens basados en la curva
  ...
  <Tab title="Casos Límite">
    **Desbordamiento del Objetivo:**
    - Si la compra excede el objetivo, se reembolsa el exceso
...
<AccordionGroup>
  <Accordion title="Comisiones de Compra">
    **En una compra de 1 token de comercio:**
    ...
    - Tokens calculados sobre el valor de 0.95 tokens de comercio
