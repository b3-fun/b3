...
<Tabs>
  <Tab title="Cómo Funciona">
    ...
    **Ejemplo de Código:**
    ...
    // Ejecutar la compra con protección de deslizamiento  
...
<AccordionGroup>
  ...
  <Accordion title="Tarifas de Venta">
    ...
    **Ejemplo:**
    ...
    // Tarifa: 0.05 token de comercio
    // El usuario recibe: 0.95 tokens de comercio
    // La curva cae por 1 token de comercio
    ```
  </Accordion>
...
1. **Llenado Parcial**: Solo se acepta la cantidad necesaria
...
<Warning>
  **Crítico: Después de la Migración**
  ...
  Una vez que se llama a `migrateToDex()`:
