...
**Ejemplo:** 10M B3 objetivo, 1.25M de suministro total de tokens (1M disponible para bonificación, 250K reservados para LP)
...
- **Agresividad**: 45
- **Objetivo**: 25 ETH
- **Resultado**: Crecimiento constante durante 3 días, 2.5x ventaja para compradores tempranos
