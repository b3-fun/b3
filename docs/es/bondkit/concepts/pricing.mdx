...
**Ejemplo:** Objetivo de 10M B3, suministro total de tokens 1.25M (1M disponible para bonificación, 250K reservados para LP)
...
4. **Impacto en el Precio**: Ventas grandes impactan significativamente el precio
...
<Warning>
  **Consideraciones Importantes:**
  ...
  1. **Reembolsos**: Si una compra excediera el objetivo, se reembolsa el exceso de ETH
