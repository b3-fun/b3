...
- **Agresividad**: 100 (máxima recompensa para los primeros compradores)
...
| Progreso del 50% | ~114,000 tokens | ~8.8 B3/token |  
| Progreso del 90% | ~49,000 tokens | ~20.4 B3/token |
...
function calculateTokensReceived(
  ...
  // Calcula el suministro en la cantidad actual recaudada
...
- **Agresividad**: 10
- **Objetivo**: 50 ETH
- **Resultado**: Precios casi lineales, la comunidad apreció la equidad

### Estudio de Caso: Token con Hype
- **Agresividad**: 85
- **Objetivo**: 100 ETH
- **Resultado**: Alcanzó el objetivo en 2 horas, los primeros compradores ganaron 8x

### Estudio de Caso: Proyecto Equilibrado
- **Agresividad**: 45
- **Objetivo**: 25 ETH
- **Resultado**: Crecimiento constante durante 3 días, ventaja de 2.5x para los primeros compradores
