...
**Ejemplo:** 10M B3 objetivo, 1.25M suministro total de tokens (1M disponible para bonificación, 250K reservados para LP)
...
**Compra de Alice:**
Alice decide comprar 1M B3 en tokens justo en el lanzamiento (0% de progreso).
...
| Progreso del Proyecto | 1M B3 de Alice Le Consigue | Precio por Token |
|-----------------------|----------------------------|------------------|
...
function calculateTokensReceived(
  ...
  // Calcular suministro en lo recaudado actualmente
...
function calculateTradingTokenReceived(
  ...
  // Calcular nuevo suministro después de vender
...
<Warning>
  **Consideraciones Importantes:**
  ...
  2. **Montos Mínimos**: Las transacciones muy pequeñas pueden revertirse debido al redondeo
