...
title: Precios
description: >-
  El modelo de precios de curva de vinculación y el papel del
...
```typescript
// Calcula los tokens recibidos por una cantidad dada de tokens de intercambio
function calculateTokensReceived(
  ...
  // Calcula el suministro en el monto actual recaudado
...
```typescript
// Calcula los tokens de intercambio recibidos por vender tokens
function calculateTradingTokenReceived(
  ...
  // Calcula el nuevo suministro después de vender
