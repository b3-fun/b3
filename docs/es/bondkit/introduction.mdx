...
<AccordionGroup>
  ...
  <Accordion title="📈 Curva de Bonificación Dinámica">
    ...
    - **Descubrimiento Automático del Precio**: Precios impulsados por el mercado durante la fase de bonificación
  ...
  <Accordion title="🎯 Migración Basada en Objetivos">
    - **Objetivos Personalizables**: Establece tu meta de financiación en ETH o ERC20 permitido
    ...
    - **Cálculo del Precio**: `sqrtPriceX96` calculado en cadena para una fijación de precios justa
  </Accordion>
  ...
  <Accordion title="📊 Análisis y Monitoreo">
    ...
    - **Datos OHLCV**: Gráficos de comercio profesional disponibles a través de API
...
<Tabs>
  <Tab title="Conceptos Clave">
    | Término | Definición |
    |------|------------|
    | **Fase de Bonificación** | Período de comercio inicial con precios algorítmicos a través de curva de bonificación |
    ...
    | **Activo de Cotización** | La moneda utilizada para comprar tokens (ETH o ERC20 permitido) |
  </Tab>
