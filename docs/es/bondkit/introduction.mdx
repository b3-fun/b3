...
BondKit es una plataforma completa de lanzamiento de tokens para crear "tokens de bono" ERC20 en Base mainnet. Proporciona una solución de principio a fin que maneja todo, desde la creación inicial del token hasta el comercio con curva de bonificación y finalmente la migración a Uniswap v4 para un comercio descentralizado completo.

### Componentes Clave

<Tabs>
  <Tab title="Smart Contracts">
    **Infraestructura On-Chain Auditada**
...
2. **Fase de Bonificación**: Creación de mercado automatizada a través de curva de bonificación
...
<AccordionGroup>
  <Accordion title="🏭 Despliegue de Patrón de Fábrica">
    - **Clones Eficientes en Gas**: Utiliza el patrón de proxy mínimo para reducir los costos de despliegue en ~90%
  ...
  <Accordion title="📈 Curva de Bonificación Dinámica">
    ...
    - **Tarifa de Comercio del 5%**: Aplicada a compras y ventas, distribuida al receptor de la tarifa
  </Accordion>
  ...
  <Accordion title="🎯 Migración Basada en Objetivos">
    ...
    - **Detección Automática de Umbrales**: El contrato rastrea el progreso hacia el objetivo
    - **Migración con Un Clic**: Llamada simple a `migrateToDex()` cuando estés listo
    - **Cálculo de Precios**: `sqrtPriceX96` calculado on-chain para una fijación de precios justa inicial
  </Accordion>
  
  <Accordion title="🔄 Integración con Uniswap v4">
    - **Creación Automática del Pool**: Pool inicializado con precio de salida de la curva de bonificación
  ...
  <Accordion title="📊 Análisis y Monitoreo">
    - **Indexación en Tiempo Real**: Todas las transacciones grabadas y procesadas
    - **Datos OHLCV**: Gráficos de trading profesionales disponibles a través de API
    - **Historial de Transacciones**: Rastro de auditoría completo para cada token
    - **Seguimiento de Cartera**: Monitorea múltiples tokens y posiciones
  </Accordion>
</AccordionGroup>
...
### Características de Smart Contract
...
- ✅ Seguimiento de cartera de usuarios
...
<Tabs>
  <Tab title="Conceptos Clave">
    | Término | Definición |
    |------|------------|
    | **Fase de Bonificación** | Periodo inicial de comercio con precios algorítmicos a través de la curva de bonificación |
    | **Token de Bono** | Token ERC20 con mecánicas integradas de curva de bonificación |
    | **Cantidad Objetivo** | Meta de financiación que activa la elegibilidad para la migración |
  ...
  <Tab title="Términos Técnicos">
    ...
    | **Ratio de División de LP** | Porcentaje de tarifa de proveedor de liquidez en puntos básicos |
  </Tab>
  ...
  <Tab title="Términos del SDK">
    ...
    | **Cliente Público** | Conexión blockchain solo lectura |
    | **Cliente de Cartera** | Conexión blockchain con capacidad de escritura |
...
<Note>
  ...
  **Tokens de Comercio Soportados**: 
  ...
  - Se pueden autorizar tokens ERC20 adicionales
  
  **Estructura de Tarifas**:
  - 5% en todas las transacciones de la fase de bonificación
  - Ratio de división de LP personalizable para la migración
