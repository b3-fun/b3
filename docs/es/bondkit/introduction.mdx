...
description: >-
  Producto para lanzar tokens de bono ERC20 en Base con una fase de emisión y
  migración sin problemas a Uniswap v4.
lang: es
originalPath: bondkit/introduction.mdx
---
## ¿Qué es BondKit?

BondKit es una plataforma completa de lanzamiento de tokens para crear "tokens de bono" ERC20 en la red principal de Base. Proporciona una solución de principio a fin que maneja todo, desde la creación inicial del token hasta el comercio mediante curva de bonificación y finalmente la migración a Uniswap v4 para un comercio descentralizado completo.
...
<Tabs>
  <Tab title="Contratos Inteligentes">
    **Infraestructura On-Chain Auditada**
    ...
    - Inicialización automática de pool en Uniswap v4
...
<AccordionGroup>
  ...
  <Accordion title="🎯 Migración Basada en Objetivos">
    ...
    - **Cálculo de Precio**: `sqrtPriceX96` calculado en cadena para una fijación de precios justa
  </Accordion>
  
  <Accordion title="🔄 Integración con Uniswap v4">
    - **Creación Automática de Pool**: Pool inicializado con precio de salida de la curva de bonificación
    ...
    - **Transición Sin Esfuerzo**: No se requiere intervención manual
  </Accordion>
...
- ✅ Seguimiento de portafolio de usuario
...
<CardGroup cols={2}>
  ...
  <Card title="Chatea con el Equipo" icon="discord" href="https://discord.gg/b3dotfun">
...
<Tabs>
  <Tab title="Conceptos Básicos">
    | Término | Definición |
    |------|------------|
    | **Fase de Bonificación** | Periodo inicial de comercio con precios algorítmicos vía curva de bonificación |
...
<Note>
  ...
  **Estructura de Tarifas**:
  ...
  - Ratio de división de LP personalizable para migración
