...
2. **Fase de Bonos**: Creación de mercado automatizada vía curva de bonos
...
- ✅ Lógica de manejo de errores y reintento
...
<Tabs>
  <Tab title="Conceptos Básicos">
    | Término | Definición |
    |------|------------|
    | **Fase de Bonos** | Período de comercio inicial con precios algorítmicos vía curva de bonos |
    ...
    | **Migración** | Transición de curva de bonos a Uniswap v4 |
  ...
  <Tab title="Términos Técnicos">
    ...
    | **Destinatario de Tarifas** | Dirección que recibe las tarifas de comercio durante la bonificación |
  ...
  <Tab title="Términos del SDK">
    ...
    | **Cliente de Cartera** | Conexión blockchain habilitada para escritura |
...
<Note>
  ...
  **Estructura de Tarifas**:
  ...
  - Proporción de división de LP personalizable para migración
