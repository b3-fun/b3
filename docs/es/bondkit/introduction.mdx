...
BondKit es una plataforma completa de lanzamiento de tokens para crear "tokens de bono" ERC20 en la red principal de Base. Proporciona una solución de principio a fin que maneja todo, desde la creación inicial del token hasta el comercio mediante curva de bonos y finalmente la migración a Uniswap v4 para un comercio descentralizado completo.
...
2. **Fase de Bonos**: Creación de mercado automatizada mediante curva de bonos
...
<AccordionGroup>
  ...
  <Accordion title="📈 Curva de Bonos Dinámica">
    ...
    - **Descubrimiento Automático de Precios**: Precios impulsados por el mercado durante la fase de bonos
    - **Soporte de Compra y Venta**: Comercio bidireccional completo durante la bonificación
    - **Tarifa de Comercio del 5%**: Aplicada a compras y ventas, distribuida al destinatario de la tarifa
  </Accordion>
  ...
  <Accordion title="🎯 Migración Basada en Objetivos">
    ...
    - **Cálculo de Precios**: `sqrtPriceX96` calculado en cadena para una fijación de precios justa
  </Accordion>
...
<CardGroup cols={3}>
  ...
  <Card title="🏢 Integración de DApp" icon="building">
    **Para Desarrolladores**
    - Creación de tokens programática
...
<Tabs>
  <Tab title="Conceptos Básicos">
    | Término | Definición |
    |------|------------|
    | **Fase de Bonos** | Período de comercio inicial con precios algorítmicos mediante curva de bonos |
    | **Token de Bono** | Token ERC20 con mecánicas de curva de bonos integradas |
  ...
  <Tab title="Términos Técnicos">
    ...
    | **Destinatario de la Tarifa** | Dirección que recibe las tarifas de comercio durante la bonificación |
    | **Relación de División de LP** | Porcentaje de tarifa del proveedor de liquidez en puntos básicos |
  </Tab>
  ...
  <Tab title="Términos del SDK">
    ...
    | **Cliente Público** | Conexión a blockchain solo lectura |
    | **Cliente de Cartera** | Conexión a blockchain con permisos de escritura |
...
<Note>
  ...
  **Estructura de Tarifas**:
  - 5% en todas las transacciones de la fase de bonos
