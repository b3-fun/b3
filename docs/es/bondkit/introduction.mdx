...
BondKit es una plataforma completa de lanzamiento de tokens para crear "tokens de bono" ERC20 en la red principal de Base. Proporciona una solución de principio a fin que maneja todo, desde la creación inicial del token hasta el comercio con curva de bonos y finalmente la migración a Uniswap v4 para un comercio descentralizado completo.
...
<AccordionGroup>
  ...
  <Accordion title="📈 Curva de Bonos Dinámica">
    ...
    - **Comisión de Comercio del 5%**: Aplicada a compras y ventas, distribuida al receptor de la comisión
  </Accordion>
...
- ✅ Mecanismo de distribución de comisiones integrado
...
<Tabs>
  <Tab title="Conceptos Básicos">
    | Término | Definición |
    |------|------------|
    | **Fase de Bonificación** | Período inicial de comercio con precios algorítmicos vía curva de bonos |
    | **Token de Bono** | Token ERC20 con mecánicas integradas de curva de bonos |
    ...
    | **Activo de Cotización** | La moneda usada para comprar tokens (ETH o ERC20 permitidos) |
  </Tab>
  ...
  <Tab title="Términos Técnicos">
    ...
    | **Receptor de Comisiones** | Dirección que recibe las comisiones de comercio durante la bonificación |
    | **Proporción de División de LP** | Porcentaje de comisión de proveedor de liquidez en puntos básicos |
  </Tab>
  ...
  <Tab title="Términos del SDK">
    ...
    | **Cliente de Cartera** | Conexión de blockchain con capacidad de escritura |
...
<Note>
  **Red Actual**: Solo red principal de Base
  
  **Tokens de Comercio Soportados**: 
  - Token B3 (principal en la red principal de Base)
