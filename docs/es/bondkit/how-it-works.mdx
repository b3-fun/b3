...
<Steps>
  ...
  <Step title="Fase 2: Trading en la Curva de Bonding">
    **Qué sucede:**
    ...
    - El precio sigue una curva de bonding algorítmica: `S = S_final × (R/R_target)^exponente`
    - Comisión del 5% en todos los trades para el destinatario de la comisión
    ...
    **Mecánicas de Trading:**
    - Compra: Enviar ETH/B3, recibir tokens al precio actual de la curva
    - Venta: Enviar tokens, recibir ETH/B3 menos comisiones
  ...
  <Step title="Fase 3: Migración a DEX">
    ...
    **Post-migración:**
    - Curva de bonding desactivada permanentemente
...
| **Destinatario de Comisiones** | Recibir comisiones de trading | Ingresos pasivos solamente |
| **Admin de Migración** | Ejecutar migración cuando esté listo | Derecho de migración único |
...
La curva de bonding determina el precio del token basado en el suministro:
...
- R = Cantidad recaudada (ETH/B3)
- R_target = Cantidad objetivo
...
|-----------|------|--------------|--------|
| `name` | string | 1-50 caracteres | Nombre visible del token |
...
| Objetivo Mínimo | 0.1 ETH | Objetivo viable mínimo |
| Agresividad Máxima | 100 | Factor máximo de la curva |
...
<Warning>
  **Características de Seguridad Importantes:**
  ...
  2. **Sin Función de Acuñación**: Suministro fijado en la creación
...
<CardGroup cols={2}>
  <Card title="Mecánicas de Precios" icon="chart-line" href="/bondkit/concepts/pricing">
    Entender las matemáticas de la curva de bonding
  </Card>
