...
<AccordionGroup>
  ...
  <Accordion title="🌐 API REST">
    ...
    **Endpoints:**
    ...
    - `/tokens/{address}/transactions` - Historial de transacciones
...
| **Administrador de Migración** | Ejecutar migración cuando esté listo | Derecho de migración único |
...
| `finalTokenSupply` | uint256 | > 0 | Tokens totales acuñables |
...
|----------|-------|-------------|
| Comisión de Trading | 5% | Aplicada a todas las transacciones |
| Decimales | 18 | Decimales estándar ERC20 |
| Min Objetivo | 0.1 ETH | Objetivo mínimo viable |
| Máx Agresividad | 100 | Factor máximo de la curva |
...
| Intento de migración por no-admin | Transacción revierte |
| Intento de doble migración | Transacción revierte |
| Operaciones con dirección cero | Transacción revierte |
