...
<Steps>
  <Step title="Fase 1: Creación de Token">
    **Qué sucede:**
    ...
    - El token entra automáticamente en la fase de bonificación
    
    **Costo de Gas:** ~200,000 gas (90% más barato que un despliegue completo)
    **Tiempo:** ~15 segundos
  </Step>
  
  <Step title="Fase 2: Comercio en la Curva de Bonificación">
    **Qué sucede:**
    - Los usuarios compran/venden tokens directamente del contrato
    - El precio sigue una curva de bonificación algorítmica: `S = S_final × (R/R_objetivo)^exponente`
    - Comisión del 5% en todas las transacciones para el destinatario de la comisión
  ...
  <Step title="Fase 3: Migración a DEX">
    ...
    **Post-migración:**
    - Curva de bonificación deshabilitada permanentemente
...
<AccordionGroup>
  <Accordion title="🏭 Contrato de Fábrica">
    **Propósito:** Despliega nuevos tokens de bonificación de manera eficiente
  ...
  <Accordion title="📜 Contrato de Implementación">
    **Propósito:** Plantilla para todos los tokens de bonificación
    
    **Características Principales:**
    - Cumplimiento del estándar ERC20
    - Matemáticas de la curva de bonificación
    - Lógica de migración a Uniswap v4
    - Sistema de distribución de comisiones
    
    **Transiciones de Estado:**
    1. No inicializado → Fase de Bonificación
    2. Fase de Bonificación → Listo para Migración
  ...
  <Accordion title="🪙 Clones de Token">
    ...
    **Ciclo de Vida:**
    ...
    - Gestiona su propia curva de bonificación
    - Se auto-migra a Uniswap v4
    
    **Almacenamiento:**
    - Metadatos del token (nombre, símbolo)
    - Suministro y distribución
    - Estado de la curva de bonificación
...
| **Comerciantes** | Comprar/vender durante la bonificación, comerciar en DEX | Derechos de comercio estándar |
| **Destinatario de Comisiones** | Recibir comisiones de comercio | Ingresos pasivos solamente |
...
La curva de bonificación determina el precio del token basado en el suministro:
...
Donde:
- S = Suministro actual de token
- S_final = Suministro final de token
...
1. **Calcula el precio de salida** de la curva de bonificación
...
| Migrar | Ninguno | Objetivo alcanzado, solo administrador |
...
<Warning>
  **Características de Seguridad Importantes:**
  ...
  2. **Sin Función de Minteo**: Suministro fijado en la creación
  ...
  5. **Sin Puertas Traseras de Administrador**: Verdadera descentralización
