...
<AccordionGroup>
  ...
  <Accordion title="📜 Contrato de Implementación">
    ...
    **Transiciones de Estado:**
    ...
    3. Listo para Migración → Fase de DEX
  </Accordion>
...
|------|-----------------|-------------|
| **Creador** | Despliega token, establece parámetros, inicia migración | Control total hasta la migración |
| **Traders** | Compra/venta durante el bonding, comercio en DEX | Derechos de trading estándar |
| **Destinatario de Comisiones** | Recibe comisiones de trading | Solo ingresos pasivos |
| **Admin de Migración** | Ejecuta la migración cuando esté listo | Derecho de migración único |
| **Proveedores de LP** | (Post-migración) Añade liquidez a Uniswap | Derechos estándar de LP |
...
<Warning>
  **Características de Seguridad Importantes:**
  ...
  2. **Sin Función de Mint**: Suministro fijo en la creación
