...
<AccordionGroup>
  <Accordion title="🏭 Contrato de Fábrica">
    ...
    **Funciones Clave:**
    - `deployBondkitToken()` - Crea nuevo clon de token
...
<Info>
  **Patrón de Proxy Mínimo (EIP-1167)**
  ...
  - Despliega un contrato de implementación (600KB)
  - Despliega contratos proxy diminutos (45 bytes cada uno)
...
| `lpSplitRatioFeeRecipientBps` | uint256 | 0-10000 | Participación en comisiones de LP (puntos básicos) |
...
<Warning>
  **Características de Seguridad Importantes:**
  ...
  6. **Protección contra Deslizamiento**: Integrada en funciones de compra/venta
