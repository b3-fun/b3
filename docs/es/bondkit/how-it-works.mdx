...
<Steps>
  ...
  <Step title="Fase 2: Comercio en la Curva de Bonding">
    **Qué sucede:**
...
<AccordionGroup>
  <Accordion title="🏭 Contrato Factory">
    ...
    **Funciones Clave:**
    ...
    - `setAllowedQuoteAsset()` - Función de administrador para autorizar activos
...
| **Comerciantes** | Comprar/vender durante el bonding, comerciar en DEX | Derechos de comercio estándar |
| **Destinatario de Comisiones** | Recibir comisiones de comercio | Ingresos pasivos solo |
...
| `lpSplitRatioFeeRecipientBps` | uint256 | 0-10000 | Participación de comisión de LP (puntos base) |
