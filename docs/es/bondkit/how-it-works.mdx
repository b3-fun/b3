...
<Steps>
  <Step title="Fase 1: Creación de Token">
    **Qué sucede:**
    ...
    - El token entra automáticamente en la fase de vinculación
    
    **Costo de Gas:** ~200,000 gas (90% más barato que un despliegue completo)
    **Tiempo:** ~15 segundos
  </Step>
  
  <Step title="Fase 2: Comercio en Curva de Vinculación">
    **Qué sucede:**
    - Los usuarios compran/venden tokens directamente del contrato
    - El precio sigue una curva de vinculación algorítmica: `S = S_final × (R/R_objetivo)^exponente`
    - Comisión del 5% en todos los comercios va al destinatario de la comisión
    ...
    **Mecánica de comercio:**
    - Comprar: Envía ETH/B3, recibe tokens al precio actual de la curva
    - Vender: Envía tokens, recibe ETH/B3 menos comisiones
  ...
  <Step title="Fase 3: Migración a DEX">
    ...
    **Post-migración:**
    - Curva de vinculación deshabilitada permanentemente
    - Todo el comercio a través de Uniswap v4
    - No quedan controles de administración
...
<AccordionGroup>
  <Accordion title="🏭 Contrato de Fábrica">
    **Propósito:** Despliega nuevos tokens de bonos de manera eficiente
  ...
  <Accordion title="📜 Contrato de Implementación">
    **Propósito:** Plantilla para todos los tokens de bonos
    
    **Características Principales:**
    - Cumplimiento del estándar ERC20
    - Matemáticas de curva de vinculación
    - Lógica de migración a Uniswap v4
    - Sistema de distribución de comisiones
    
    **Transiciones de Estado:**
    1. No inicializado → Fase de Vinculación
    2. Fase de Vinculación → Listo para Migración
  ...
  <Accordion title="🪙 Clones de Token">
    ...
    **Ciclo de Vida:**
    - Creado a través de la fábrica
    - Inicializado con parámetros únicos
    - Gestiona su propia curva de vinculación
    - Se auto-migra a Uniswap v4
    
    **Almacenamiento:**
    - Metadatos del token (nombre, símbolo)
    - Suministro y distribución
    - Estado de la curva de vinculación
...
<AccordionGroup>
  ...
  <Accordion title="📊 Motor de Análisis">
    **Propósito:** Procesa datos brutos en perspectivas
  ...
  <Accordion title="🌐 API REST">
    ...
    **Endpoints:**
    ...
    - `/users/{address}/portfolio` - Posesiones del usuario
...
| **Comerciantes** | Comprar/vender durante la vinculación, comerciar en DEX | Derechos de comercio estándar |
| **Destinatario de Comisiones** | Recibir comisiones de comercio | Solo ingresos pasivos |
...
### Matemáticas de la Curva de Vinculación

La curva de vinculación determina el precio del token basado en la oferta:
...
1. **Calcula el precio de salida** de la curva de vinculación
...
| Min Objetivo | 0.1 ETH | Objetivo viable mínimo |
...
| Liquidez insuficiente para vender | La transacción se revierte |
| Migración antes del objetivo | La transacción se revierte |
| Intento de migración por no-admin | La transacción se revierte |
| Intento de doble migración | La transacción se revierte |
| Operaciones de dirección cero | La transacción se revierte |

## Próximos Pasos

<CardGroup cols={2}>
  <Card title="Mecánica de Precios" icon="chart-line" href="/bondkit/concepts/pricing">
    Entender las matemáticas de la curva de vinculación
  </Card>
