...
Experience B3 authentication in action. Try signing in with different providers:

<iframe
  src="https://login-minimal-b3.vercel.app/"
  width="100%"
  height="600px"
...
<Note>
  This is a live demo showing the SignInWithB3 component. Try signing in with Google, Discord, or other providers to see how it works.
</Note>
...
<Note>
  When you don't specify `strategies`, the SignInWithB3 component will display all available authentication options.
</Note>
