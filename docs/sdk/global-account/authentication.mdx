...
Experience B3 authentication in action with a live, interactive component:
...
<Note>
  This is a **live, interactive demo** using the actual B3 SDK. Try authenticating with different providers and see real-time results. View the [full demo page](https://global.b3.fun/demos) for more examples.
</Note>
...
<iframe
  ...
  title="All Authentication Strategies Demo"
/>
