...
<AccordionGroup>
  <Accordion title="错误：'Buy: 执行回退' 或 'Sell: 执行回退'">
    **原因：** 在债券阶段期间各种交易问题。
          ...
          return {
            ...
            quoteMethod: async (amount) => {
              const params = {
                ...
                tokenOutDecimals: 18,
                slippageTolerance: 0.005,
                recipient: "0x0000000000000000000000000000000000000000" // 报价的虚拟地址
              };
