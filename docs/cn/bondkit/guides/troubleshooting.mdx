...
<AccordionGroup>
  <Accordion title="错误：'购买：执行回滚' 或 '出售：执行回滚'">
    **原因：** 在债券阶段期间各种交易问题。
...
<AccordionGroup>
  ...
  <Accordion title="燃气估计问题">
    **问题：** 交易因“燃气耗尽”或燃气估计错误而失败。
