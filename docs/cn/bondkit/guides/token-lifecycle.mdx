...
<AccordionGroup>
  <Accordion title="选择您的参数">
    **关键决策:**
    ...
    | **aggressivenessFactor** | 价格曲线的陡峭度 | 30-60 适用于平衡发行 |
...
<Tabs>
  <Tab title="社区建设">
    ...
    **发行日:**
    ...
    console.log(`🚀 现已上线 ${formatEther(price)} B3 每代币`);
  ...
  <Accordion title="最佳时机">
    ...
    **迁移前公告:**
    ...
    const announcement = `
      ...
      • 开盘价: ~${calculateOpeningPrice(migrationData)} B3/代币
