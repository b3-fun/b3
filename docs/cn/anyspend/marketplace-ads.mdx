...
使用 USDC 在 100 多个加密内容网站购买广告位，得益于 x402 无燃气费支付，**零燃气费**。
...
<CardGroup cols={2}>
  ...
  <Card title="实时跟踪" icon="list-check">
    实时监控您的广告和文章请求
  </Card>
</CardGroup>
...
<Note>
  需要在 Base 上的 USDC？使用 [Base Bridge](https://bridge.base.org) 从以太坊桥接
</Note>
...
返回包括定价、格式和相关网站详情的静态广告位信息。此端点免费调用。
...
返回当前在此广告位运行的广告，或指示广告位是否可用。此端点免费调用。
...
```json 批准响应（分数 ≥70）
{
  ...
  "data": {
    "approved": true,
    "score": 92,
    "reasoning": "对 Base 生态系统内容的绝佳主题匹配",
    "estimatedPrice": "15000000",
    "suggestedTitle": "如何在您的 DApp 中使用 Base Pay 为创作者付款",
    "suggestedDescription": "学习如何将 Base Pay 集成到您的去中心化应用中...",
