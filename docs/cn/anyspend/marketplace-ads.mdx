...
<Note>
  需要在 Base 上使用 USDC 吗？使用 [Base Bridge](https://bridge.base.org) 从 Ethereum 桥接
</Note>
...
<Steps>
  ...
  <Step title="发布">
    网站发布您的文章，并您将收到现场 URL
  </Step>
</Steps>

### 定价

价格因网站而异，通常为 **$3-50 USDC** 每篇文章。每个网站根据流量和受众设定自己的价格。
...
<Note>
  有关使用 `wrapFetchWithPayment` 的更多详细信息，请参阅 [x402 SDK 文档](/anyspend/x402-overview)。
</Note>
