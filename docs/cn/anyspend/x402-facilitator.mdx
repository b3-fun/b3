...
- **买家灵活性**：用户可以用他们持有的任何代币支付
- **卖家偏好**：商家收到他们选择的结算货币
- **最佳定价**：通过最优的 DEX 流动性源路由
- **滑点保护**：自动防范价格影响的安全措施
...
- ✅ **基于 HTTP 的支付** 通过 `402 Payment Required` 状态
...
```json
{
  "tokenAmount": "1000000000000000000",  // 需要 1.0 DAI
  "exchangeRate": "1.0",
  "deadline": 1730000000,
  "route": {
    "srcToken": "0x50c5...",
