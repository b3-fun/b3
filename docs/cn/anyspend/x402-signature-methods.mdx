...
description: 无需 Gas 的支付签名：EIP-2612 许可和 EIP-3009 transferWithAuthorization
lang: cn
originalPath: anyspend/x402-signature-methods.mdx
---
## 概述

AnySpend x402 使用加密签名代替传统的令牌授权，为用户启用**无需支付燃气费的支付**。服务商支付所有燃气费，而用户只需签署授权消息。
...
<Note>
所有燃气费用由服务商支付，并包含在 0.25% 的 AnySpend 费用中。用户永远不直接支付燃气费。
</Note>
