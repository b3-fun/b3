...
- **Ramah agen AI** - Pembungkus fetch sederhana untuk pembayaran otonom
...
- Mengembalikan hash transaksi dalam header `x-payment-response`
...
<Card title="Metode Tanda Tangan" icon="signature" href="/anyspend/x402-signature-methods">
  Penyelaman mendalam ke dalam tanda tangan transaksi Solana
</Card>
