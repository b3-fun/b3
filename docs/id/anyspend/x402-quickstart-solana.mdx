...
---
<Note>
**Cobalah secara langsung!** Rasakan X402 di Solana di [x402-demo.anyspend.com](https://x402-demo.anyspend.com/) atau jelajahi [kode sumber di GitHub](https://github.com/b3-fun/anyspend-x402-demo).
</Note>
...
// Konfigurasi titik akhir pembayaran
app.use(
  paymentMiddleware(
...
### Opsi 1: Menggunakan Fetch (Agen AI & Backend)
...
Untuk aplikasi web yang menggunakan Phantom, Solflare, Ledger, atau dompet Solana lainnya.
...
- Menghubungkan Solana Wallet Adapter v1 dengan tanda tangan X402 v2
...
```typescript
{
  address: 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v', // Mint USDC
  decimals: 6,
}
```
...
<Card title="Metode Tanda Tangan" icon="signature" href="/anyspend/x402-signature-methods">
  Studi mendalam tentang tanda tangan transaksi Solana
</Card>
...
Verifikasi:
- Titik akhir server dikonfigurasi dengan benar
...
- **Discord**: Bergabung dengan [komunitas Discord](https://discord.gg/b3dotfun) kami
