...
| **Eksekusi** | Dua langkah: approve + transfer | Satu langkah: transfer langsung |
...
- ✅ **Eksekusi satu langkah** - Transfer langsung, tidak memerlukan persetujuan
- ✅ **Nonce acak** - Tidak ada ketergantungan berurutan, transaksi paralel dimungkinkan
...
Persetujuan berbasis tanda tangan yang menetapkan izin, diikuti oleh panggilan `transferFrom()` terpisah. Ini adalah metode standar untuk sebagian besar token ERC-20 modern.
...
Fasilitator memanggil `permit()` untuk menetapkan izin di rantai
</Step>
...
- Transaksi paralel dimungkinkan
