...
- **API Express.js** (atau kesediaan untuk membuat satu)
...
Paket `@b3dotfun/anyspend-x402` termasuk instance fasilitator yang telah dikonfigurasi sebelumnya:
...
**Contoh 1: Terima USDC (Stablecoin)**
...
**Contoh 2: Terima Token B3 (Token Khusus)**
...
**Contoh 3: Terima DAI (Stablecoin)**
...
**Contoh 5: Terima Token ERC-20 Khusus**

Untuk token ERC-20 apa pun dengan dukungan izin:
...
Untuk mengonfigurasi token khusus, Anda perlu mengetahui parameter EIP-712-nya. Begini cara menemukannya:

**Metode 1: Periksa Kontrak Token**

Gunakan eksplorer blockchain seperti [Basescan](https://basescan.org):
...
Izinkan klien menentukan token pembayaran pilihan mereka:
...
const testFacilitator = new Facilitator({
  baseUrl: 'https://testnet.anyspend.com
