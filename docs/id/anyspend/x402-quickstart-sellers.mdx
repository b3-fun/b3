...
Paket `@b3dotfun/anyspend-x402` mencakup instance fasilitator yang telah dikonfigurasi sebelumnya:
...
- AnySpend secara otomatis mengonversi token mereka ke token yang ingin Anda terima
- Anda menerima tepat token yang Anda tentukan dalam konfigurasi Anda
- Fleksibilitas pembeli dan penjual tetap dipertahankan
</Note>
...
const customFacilitator = new Facilitator({
  ...
  retries: 3                                  // Coba kembali permintaan yang gagal
});
