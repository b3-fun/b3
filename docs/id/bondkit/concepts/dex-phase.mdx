...
| **Biaya** | 5% untuk penerima biaya | 0.3% untuk LP + protokol |
| **Tipe Order** | Hanya beli/jual | Fitur DEX penuh |
...
await token.migrateToDex();         // Tindakan satu kali
...
<AccordionGroup>
  <Accordion title="Strategi Perdagangan Optimal">
    ...
    **Pertimbangan Waktu:**
    ...
    - Gunakan pesanan batas bila tersedia
