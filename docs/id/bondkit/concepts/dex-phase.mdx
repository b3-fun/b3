...
const poolConfig = {
  ...
  tickSpacing: 60,  // Spasi tick standar
...
- **Token Bondkit**: Jumlah dihitung untuk mencocokkan harga keluar
...
**Manfaat LP:**
- **Biaya Perdagangan**: Dapatkan 0.3% dari seluruh volume tukar
...
await token.migrateToDex();         // Tindakan sekali waktu
...
<AccordionGroup>
  <Accordion title="Apakah token bisa kembali ke fase obligasi?">
