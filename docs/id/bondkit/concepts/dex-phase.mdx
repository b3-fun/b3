...
- **Token Bondkit**: Jumlah yang dihitung untuk mencocokkan harga keluar
...
- Dinamika buku pesanan real-time
...
| **Likuiditas** | Tak terbatas (kontrak mencetak) | Likuiditas kolam terbatas |
| **Biaya** | 5% ke penerima biaya | 0.3% ke LP + protokol |
| **Jenis Pesanan** | Hanya beli/jual | Fitur DEX penuh |
...
Token Bondkit di Uniswap v4 menyertakan hook kustom untuk fungsionalitas yang ditingkatkan:
...
- ⚠️ Likuiditas tidak dijamin (tergantung pada kedalaman kolam)
...
<AccordionGroup>
  <Accordion title="Strategi Perdagangan Optimal">
    **Manajemen Slippage:**
    ...
    - Slippage lebih tinggi untuk jumlah yang lebih besar
...
<AccordionGroup>
  <Accordion title="Apakah token dapat kembali ke fase obligasi?">
    **Tidak** - Migrasi permanen dan tidak dapat dibalik. Setelah di fase DEX, token akan selalu diperdagangkan di Uniswap v4.
  </Accordion>
  ...
  <Accordion title="Bagaimana biaya perdagangan berbeda?">
    Fase DEX menggunakan biaya Uniswap v4 standar (0.3%) yang diberikan kepada penyedia likuiditas bukan biaya fase obligasi 5% ke penerima biaya.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Mulai Perdagangan DEX" icon="arrow-right" href="/bondkit/sdk/reference#bondkitswapservice">
    Pelajari penggunaan BondkitSwapService untuk perdagangan DEX
  </Card>
