...
Appchains, L2s, dan L3s memiliki likuiditas yang terisolasi, membuatnya menyebalkan untuk membangun pengalaman tanpa harus menjembatani aset lintas rantai.
...
<Card title="UX yang Buruk" icon="face-frown">
  Pengguna secara manual menjembatani aset dan mengelola beberapa dompet.
</Card>
