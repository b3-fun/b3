...
<Step title="Enter B3 Details">
  ...
  New RPC URL: {networks.b3.mainnet.rpc}
  Chain ID: {networks.b3.mainnet.chainId}
  Currency symbol: ETH
  Block explorer URL: {networks.b3.mainnet.explorer}
  ```
</Step>
...
<Step title="Configure B3 Network">
  ...
  <CodeGroup>
    ...
    ```
    ```text
    RPC URL: {networks.b3.mainnet.rpc}
    ```
    ```text
    Block Explorer: {networks.b3.mainnet.explorer}
    ```
  </CodeGroup>
</Step>
