...
단지 이러한 일반적인 브랜드 색상에 자신을 제한하지 마십시오. B3는 다양한 재미있고 생동감 있는 색상 팔레트로 표현하도록 초대합니다.
...
<CardGroup cols={2}>
  <Card title="공간을 주세요" icon="expand">
    우리의 로고는 적절한 여백이 있을 때 가장 잘 작동합니다.
  </Card>
  
  <Card title="재미있게 만드세요" icon="heart">
    가볍고 친근하며 참여적인 분위기를 유지하세요.
  </Card>
</CardGroup>
...
B3를 대표할 때 애니메이션은 환영받습니다, 결국 - 움직임은 재미있습니다!
...
B3는 재미있게 지내는 것에 관한 것이며, 게임 & 그 이상을 통해 당신의 삶에서 그것을 대표합니다.
...
함께 B3를 구축합시다 - 창작자, 예술가, 개발자, 게이머, 플레이어 및 모든 사람의 기여를 환영하고 보상합니다.
