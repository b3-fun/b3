...
DEX 단계는 Bondkit 토큰의 생명주기의 마지막 단계로, 거래가 자동화된 본딩 곡선에서 완전히 분산된 Uniswap v4 풀로 전환됩니다. 이 단계는 마이그레이션 직후에 시작되며 완전한 분산화를 나타냅니다.
...
3. **가격 초기화**: 본딩 곡선 탈출 가격에서 초기 풀 가격 계산
...
| **수수료** | 수수료 수령인에게 5% | LPs + 프로토콜에게 0.3% |
...
<AccordionGroup>
  ...
  <Accordion title="거래 수수료는 어떻게 다른가요?">
    DEX 단계는 수수료 수령인에게 5%를 주던 본딩 단계 수수료 대신 표준 Uniswap v4 수수료(0.3%)를 사용하며, 이는 유동성 제공자에게 갑니다.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="LP 되기" icon="coins" href="https://app.uniswap.org">
