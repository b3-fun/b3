  ...
  <Accordion title="오류: 'DeployBondkitToken: 실행이 되돌아왔습니다'">
    ...
    **해결책:**
    ...
    const config = {
      ...
      lpSplitRatioFeeRecipientBps: 1000n, // 0-10000이어야 함 (기준점)
      ...
      v4TickSpacing: 60, // 요금 계층과 일치해야 함
...
<AccordionGroup>
  ...
  <Accordion title="오류: 'BondingPhaseEnded' 또는 DEX 거래 문제">
    **원인:** 토큰이 DEX 단계로 이주했지만 여전히 본딩 메소드를 사용하고 있습니다.
    
    **해결책:**
    ```typescript
    // 단계를 감지하고 적절한 메소드를 사용하세요
