...
<AccordionGroup>
  <Accordion title="파라미터 선택">
    **중요 결정사항:**
    ...
    | 파라미터 | 영향 | 권장사항 |
    |-----------|---------|----------------|
    | **finalTokenSupply** | 생성될 총 토큰 수 | 1M-100M 토큰이 일반적 |
  ...
  <Accordion title="수수료 구조 설정">
    **수수료 분배 전략:**
    ...
    const feeConfig = {
      ...
      lpSplitRatioFeeRecipientBps: 2000n, // 수수료 수령인에게 20%
  ...
  <Accordion title="최적 타이밍">
    ...
    **이주 전 발표:**
    ...
    const announcement = `
      ...
      📊 최종 결합 통계:
      • 조달: ${formatEther(progress.raised)} B3
    ...
    **교육 콘텐츠:**
    ...
    const migrationGuideForUsers = {
      ...
      risks: {
        ...
        liquidityRisk: "큰 거래는 가격 영향을 줄 수 있음",
        smartContractRisk: "
