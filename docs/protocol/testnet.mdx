...
<Card title="B3 Testnet Explorer" icon="search" href="https://testnet-explorer.b3.fun" cta="View Explorer" horizontal>
...
<CardGroup cols={3}>
  ...
  <Card title="Faucet" icon="droplets" href="https://faucet.b3.fun" cta="Get Test ETH">
