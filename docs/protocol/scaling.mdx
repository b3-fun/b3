---
title: "Horizontally Scaling Chains"
...
<img src="/images/gamechains-diagram.jpg" alt="B3 Horizontal Scaling Architecture" className="w-full rounded-2xl" />
...
<Note icon="info" title="Consolidated Data">
...
<Card title="Deploy Your Appchain" icon="rocket" href="https://b3builders.typeform.com/bsmntdevelopers" horizontal>
...
<Note icon="info" title="Build on B3">
