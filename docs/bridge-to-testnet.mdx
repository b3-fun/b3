...
<Step title="Enter Amount">
  ...
  <Card title="Need Base Sepolia ETH?" icon="droplets" href="https://sepoliafaucet.com" cta="Get Testnet ETH" horizontal>
...
<CardGroup cols={2}>
  <Card title="Base Sepolia Testnet">
    **Chain ID**: {networks.base.sepolia.chainId}  
    **RPC**: {networks.base.sepolia.rpc}  
    **Explorer**: {networks.base.sepolia.explorer}
  </Card>
...
<CardGroup cols={3}>
  <Card title="Testnet Bridge" icon="arrow-right-left" href="https://testnet.bridge.b3.fun" cta="Bridge Now">
    Official bridge for moving assets between Base Sepolia and B3 Testnet
  </Card>
  
  <Card title="B3 Testnet Faucet" icon="droplets" href="https://testnet-faucet.b3.fun" cta="Get Test ETH">
...
<CardGroup cols={2}>
  <Card title="B3 Testnet Guide" icon="flask" href="/testnet">
    Learn more about the B3 testnet environment and configuration
  </Card>
  
  <Card title="Development Setup" icon="code" href="/quickstart">
    Get started building and testing on B3
  </Card>
  
  <Card title="Unity Integration" icon="gamepad-2" href="/unity-guide">
    Integrate Unity games with B3 testnet for testing
  </Card>
  
  <Card title="Bridge to Mainnet" icon="bridge" href="/bridge">
    When ready, learn how to bridge to B3 mainnet
  </Card>
</CardGroup>
