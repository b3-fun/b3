...
<img className="block dark:hidden" src="/images/hypes-system-light.png" alt="HYPES Credit System" />
<img className="hidden dark:block" src="/images/hypes-system-dark.png" alt="HYPES Credit System" />
