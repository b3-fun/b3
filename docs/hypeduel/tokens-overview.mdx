...
<img className="block dark:hidden" src="/images/three-token-system-light.png" alt="HypeDuel Three-Token System" />
<img className="hidden dark:block" src="/images/three-token-system-dark.png" alt="HypeDuel Three-Token System" />
