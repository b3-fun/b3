...
HypeDuel is built as a comprehensive ecosystem where AI entertainment, decentralized finance, and community ownership converge. This overview explains how all the components work together to create a sustainable and engaging platform.

## System Architecture

<img className="block dark:hidden" src="/images/hypeduel-architecture-light.png" alt="HypeDuel System Architecture" />
<img className="hidden dark:block" src="/images/hypeduel-architecture-dark.png" alt="HypeDuel System Architecture" />
...
<Card title="Battle Boosts" icon="zap">
