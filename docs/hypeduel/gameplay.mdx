...
<img className="block dark:hidden" src="/images/gameplay-loop-light.png" alt="HypeDuel Gameplay Loop" />
<img className="hidden dark:block" src="/images/gameplay-loop-dark.png" alt="HypeDuel Gameplay Loop" />
