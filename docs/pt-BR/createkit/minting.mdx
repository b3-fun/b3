...
title: Cunhagem
description: >-
  Guia completo para cunhagem de tokens com CreateKit incluindo implantação,
  cunhagem regular e recursos avançados
lang: pt-BR
...
```typescript title="Implantação e Primeira Cunhagem"
...
```typescript title="Tokens Semi-Fungíveis ERC1155"
// ERC1155 - Pode cunhar múltiplos do mesmo ou diferentes tokens
const erc1155Collection = collectionManager.createCollection(
  predictedAddress,
  "ERC1155"
)

// Pode cunhar múltiplos tokens do mesmo tipo
...
```typescript title="Cunhagem com Preço Fixo"
...
```typescript title="Lógica de Preços Dinâmicos"
...
```typescript title="Configuração da Lista Branca"
...
```typescript title="Cunhagem Eficiente de Gás"
...
```typescript title="Otimização do Preço do Gás"
...
<CardGroup cols={2}>
  ...
  <Card title="Interação com Contrato Inteligente" icon="code">
    - Sempre validar parâmetros antes das transações
    - Implementar tratamento de erros adequado
    - Usar limites e preços de
