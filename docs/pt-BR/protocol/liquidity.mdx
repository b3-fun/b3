...
Appchains, L2s e L3s têm liquidez isolada, tornando frustrante construir experiências sem ter que transferir ativos entre cadeias.
...
<Card title="Integração Complexa" icon="gears">
  Os construtores devem integrar com dezenas de cadeias individualmente.
</Card>

<Card title="Experiência de Usuário Ruim" icon="face-frown">
  Usuários precisam transferir ativos manualmente e gerenciar múltiplas carteiras.
</Card>
...
Impulsionado pelo nosso produto, AnySpend, opera na camada de execução do cliente, situando-se entre a intenção do usuário e a execução blockchain:

### Como Funciona

1. **Depósito de qualquer cadeia**: Aceita tokens da maioria das cadeias
2. **Baseado em Intenção**: Usuários expressam o que querem, não como conseguir
3. **Descoberta de Rota**: Encontra caminhos ótimos entre todas as cadeias suportadas
...
AnySpend fornece suporte universal a cadeias:
