...
1. **Status do Contrato**: O status do token muda para `TokenStatus.Dex`
...
- Sujeito a volatilidade de mercado
...
**Tornando-se um LP:**
```typescript
// Adicionar liquidez ao pool do token Bondkit
...
**Benefícios LP:**
- **Taxas de Negociação**: Ganhe 0.3% de todo o volume de swap
...
- ⚠️ Preço agora sujeito a volatilidade de mercado
...
<AccordionGroup>
  ...
  <Accordion title="Existem restrições na fase DEX?">
    Sem restrições - os tokens tornam-se ERC20s padrão negociando no Uniswap v4. Composabilidade DeFi total habilitada.
  </Accordion>
