...
5. Seu manipulador de rotas executa e retorna dados
...
app.use('/api/compute', (req, res, next) => {
  // Calcular preço com base nas unidades de computação solicitadas
  ...
  // Anexar configuração dinâmica à solicitação
  req.x402Config = {
    amount: totalPrice,
    asset: 'USD'
  };
