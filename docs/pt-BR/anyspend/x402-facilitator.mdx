...
- **Pagamentos na mesma cadeia**: Transferências diretas de token com sobrecarga mínima
...
- **Roteamento otimizado**: Seleção inteligente de rotas para melhor execução
...
- **Melhores preços**: Roteamento através das fontes de liquidez DEX ótimas
...
- **Compatibilidade do cliente**: Funciona com qualquer cliente compatível com x402
- **Compatibilidade do servidor**: Pode ser usado com qualquer middleware x402
...
- Escalabilidade horizontal para alta capacidade de processamento
- Processamento paralelo de transações
...
<Card title="Multi-Chain" icon="globe">
  Suporte para 19+ redes blockchain com roteamento automático cross-chain
</Card>
