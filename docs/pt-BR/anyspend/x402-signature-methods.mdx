...
- Sem front-running - nonce aleatório previne ataques de MEV
...
permit(
    ...
    address spender,       // Despender aprovado (facilitador)
    uint256 value,         // Quantia de aprovação
...
- Estado do nonce armazenado na cadeia em mapeamento
...
O cliente AnySpend x402 lida automaticamente com toda a complexidade da assinatura:
