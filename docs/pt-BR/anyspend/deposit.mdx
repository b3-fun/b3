...
\* Não obrigatório para a cadeia Hyperliquid onde USDC é o token padrão.
...
Conexão automática habilitada para usuários que retornam e já conectaram sua carteira anteriormente.
...
- **Marketplaces** -- financiar endereços de custódia
