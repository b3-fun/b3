...
Este guia mostra como usar o **AnySpend X402** na **Solana** tanto para aplicações de servidor (aceitando pagamentos) quanto para clientes (fazendo pagamentos). AnySpend X402 na Solana possibilita pagamentos de tokens SPL sem gás usando assinaturas de transações, tornando-o perfeito para APIs com paywall, agentes de IA e serviços premium.
...
- **Amigável para agentes de IA** - Wrapper fetch simples para pagamentos autônomos
...
Aceite pagamentos em Solana USDC com apenas algumas linhas de código.
...
2. Middleware retorna `402 Payment Required` com detalhes do pagamento Solana
...
- Lida automaticamente com respostas 402 e fluxo de pagamento
...
Envolver seu app com provedores de carteira:
...
- **Discord**: Junte-se à nossa [comunidade Discord](https://discord.gg/b3dotfun)
