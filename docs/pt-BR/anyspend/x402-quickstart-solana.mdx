...
<Card title="Demo ao Vivo" icon="rocket" href="https://github.com/b3-fun/anyspend-x402-demo">
  Aplicativo demo Solana completo e funcional
</Card>
</CardGroup>

## Visão Geral

Este guia mostra como usar o **AnySpend X402** na **Solana** tanto para aplicações de servidor (aceitando pagamentos) quanto para clientes (fazendo pagamentos). AnySpend X402 na Solana possibilita pagamentos de tokens SPL sem gas usando assinaturas de transações, tornando-o perfeito para APIs com paywall, agentes de IA e serviços premium.

**Principais Características:**
- **Transações sem gas** - O facilitador patrocina todas as taxas de transação
...
Aceite pagamentos USDC Solana com apenas algumas linhas de código.
...
2. Middleware retorna `402 Pagamento Necessário` com detalhes de pagamento Solana
...
async function main() {
  ...
  // Verificar resposta de pagamento
...
- Completamente sem gas - usuários apenas assinam, facilitador paga as taxas
- Faz a ponte entre Solana Wallet Adapter v1 e assinaturas X402 v2
...
2. Use o mint USDC devnet: `4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU`
...
<Card title="Métodos de Assinatura" icon="signature" href="/anyspend/x402-signature-methods">
  Mergulhe nas assinaturas de transações Solana
</Card>
...
- A quantia de pagamento corresponde às expectativas do servidor
