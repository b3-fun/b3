...
This guide shows you how to add **AnySpend X402** payment support to your Express API, enabling you to accept payments in any token while receiving USDC. With just a few lines of code, your API can monetize endpoints and handle automatic payment verification and settlement.

Your customers can pay with ETH, DAI, or any ERC-20 token, while you receive USDC - no blockchain infrastructure required.
...
Require specific tokens on specific networks:
...
AnySpend X402 supports payments on:

- **Base** (recommended) - Fast and low cost
- **Ethereum** - Maximum liquidity
- **Arbitrum** - Low gas fees
- **Optimism** - Fast finality
- **Polygon** - Very low fees

See [Network Support](/anyspend/x402-network-support) for detailed information.

## What's Next?

<CardGroup cols={2}>
<Card title="Core Concepts" icon="book" href="/anyspend/x402-core-concepts">
  Understand how X402 payments work under the hood
</Card>
