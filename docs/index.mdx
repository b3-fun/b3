...
<CardGroup cols={2}>
  <Card href="/global-account/authentication">
    ...
    <h3 className="text-lg font-semibold text-primary block mb-1">
    Instant Login</h3>
  ...
  <Card href="/global-account/introduction">
    ...
    <h3 className="text-lg font-semibold text-primary block mb-1">
    Know Your Player's Identity</h3>
...
<CardGroup cols={2}>
  <Card href="/guides/leaderboards">
    ...
    <h3 className="text-lg font-semibold text-primary block mb-1">
    Deploy Onchain Leaderboards</h3>
  ...
  <Card href="/guides/token-gating">
    ...
    <h3 className="text-lg font-semibold text-primary block mb-1">
    Create Exclusivity with Token Gating</h3>
...
<CardGroup cols={2}>
  <Card href="/anyspend/introduction">
    ...
    <h3 className="text-lg font-semibold text-primary block mb-1">
    Accept Payments Without Friction</h3>
  ...
  <Card href="/guides/marketplace">
    ...
    <h3 className="text-lg font-semibold text-primary block mb-1">
    Turn Any Asset into a Marketplace</h3>
