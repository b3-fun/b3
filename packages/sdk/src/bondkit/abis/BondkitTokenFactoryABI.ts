export const BondkitTokenFactoryABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_implementationAddress", type: "address" },
      { internalType: "address", name: "_v4PoolManager", type: "address" },
      { internalType: "address", name: "_v4Hook", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "CloneInitializationReturnedFalse", type: "error" },
  {
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: "address", name: "cloneAddress", type: "address" }],
  ...
  {
    inputs: [{ internalType: "uint24", name: "_defaultV4PoolFee", type: "uint24" }],
  ...
  {
    inputs: [{ internalType: "int24", name: "_defaultV4TickSpacing", type: "int24" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_dexPhaseSplitter", type: "address" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_v4Hook", type: "address" }],
    name: "setV4Hook",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "address", name: "_v4PoolManager", type: "address" }],
