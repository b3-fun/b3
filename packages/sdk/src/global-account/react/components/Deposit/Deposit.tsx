...
import { B3GlobalBrandingWrapper, useAccountWallet, useModalStore } from "@b3dotfun/sdk/global-account/react";
import { TokenSelector } from "@relayprotocol/relay-kit-ui";
import { ChevronDown, ChevronLeft, Copy, X } from "lucide-react";
    ...
    <B3GlobalBrandingWrapper>
      <div className="flex w-full flex-col">
        ...
        <div className="flex h-16 items-center justify-between border-b border-[#e4e4e7] bg-white px-5 py-3">
          ...
          <p className="text-lg font-semibold leading-7 text-[#18181b]">Deposit</p>
          <button
