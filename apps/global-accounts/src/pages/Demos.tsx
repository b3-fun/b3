            ...
            <div id="auth-full" className="rounded-2xl bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 rounded-md bg-blue-50 p-4">
                <p className="text-xs text-blue-900">
                  💡 <strong>Tip:</strong> This is a live, interactive component using the actual B3 SDK. Try different
                  authentication providers to see how they work.
                </p>
              </div>
            </div>
            ...
            <div id="auth-google" className="rounded-2xl bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 rounded-md border border-gray-200 bg-gray-50 p-4">
                <p className="text-xs text-gray-700">
                  ...
                  <code className="rounded bg-white px-1 py-0.5 font-mono text-xs">strategies</code> array to show only
                  that authentication option.
                </p>
              </div>
            </div>
