...
const PARTNER_ID = String(process.env.NEXT_PUBLIC_GLOBAL_ACCOUNTS_PARTNER_ID || "");
...
export default function GasFundingPage() {
  ...
  return (
    <DemoPageLayout title="Gas Funding" subtitle="No sign-up required. Pay with crypto." maxWidth="max-w-xl">
      <div className="space-y-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
        <div>
