...
export function StakeUpsideButtonExactIn() {
  ...
  return (
    <div className="flex gap-4">
      ...
      >
        <div>
          <h3 className="text-lg font-medium text-gray-900">Stake WETH (Exact In)</h3>
          <p className="mt-1 text-sm text-gray-500">Choose your amount, swap from any token and stake WETH</p>
        </div>
      </button>
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Choose your amount, swap from any token and stake B3</p>
        </div>
      </button>
    </div>
  );
